...
public class IgniteMultiMapTest {
    ...
    public void shouldDoPutTxCorrectly() {
        try (Ignite ignite = IgniteTestHelpers.getIgnite()) {
            IgniteMultiMap igniteMultiMap = new IgniteMultiMap(IgniteTestHelpers.getCacheMultiMap(ignite, "a-random-cache-name"));
    ...
    public void shouldThrow_whenPoppingFromANonExistingKeyspace() {
        try (Ignite ignite = IgniteTestHelpers.getIgnite()) {
            IgniteMultiMap emptyIgniteMultiMapCollection = new IgniteMultiMap(IgniteTestHelpers.getCacheMultiMap(ignite, "a-random-cache-name"));
